...
watch(
  ...
  (newPath) => {
    ...
    if (newPath.includes('/chat/chatroom')) {
      skipRouterName.value = 'chatroom';
    }
  },
);
      ...
      <template #default>
        <div class="setting_fun_list">
          ...
          <div class="func_item" @click="showInputModal('applyJoinGroups')">
            ...
            <span class="setting_fun_text apply_groups"> 申请入群 </span>
          </div>
        </div>
      </template>
    </el-popover>
    ...
    >
      ...
      <template #default>
        <div class="setting_fun_list">
          ...
          <!-- 个性化设置 -->
          <div class="func_item" @click="personalsetting.dialogVisible = true">
            <span class="settting_fun_icon">
              <svg
                width="20"
                height="20"
